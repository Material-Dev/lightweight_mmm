...
class ModelsTest(parameterized.TestCase):
    ...
    def test_media_mix_model_parameters_have_correct_shapes(
        ...
        self.assertEqual(jnp.squeeze(trace["expo_trend"].mean(axis=0)).shape, ())
        self.assertEqual(
        ...
        self.assertEqual(trace["gamma_seasonality"].mean(axis=0).shape, (degrees, 2))
    ...
    def test_multiplicative_media_mix_model_custom_priors_are_taken_correctly(
        self, prior_name, transform_function
    ):
        expected_value1, expected_value2 = 5.2, 7.56
        custom_priors = {
